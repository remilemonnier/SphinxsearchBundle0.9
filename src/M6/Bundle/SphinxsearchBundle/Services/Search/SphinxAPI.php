...
class SphinxClient
{
	...
	{
		assert('$ranker==SPH_RANK_PROXIMITY_BM25 || $ranker==SPH_RANK_BM25 || $ranker==SPH_RANK_NONE || $ranker==SPH_RANK_WORDCOUNT || $ranker==SPH_RANK_PROXIMITY');
		$this->_ranker = $ranker;
	}
	...
	{
		$this->_statsdtime = microtime(true);
